...
<p align="center">
  <strong>高效构建具备稳定完成复杂代码任务智能体的工具</strong>
</p>
...
Search Light Agent Team 是一个基于 Node.js 和 TypeScript 构建的智能体编排工具。它允许你将复杂的代码任务拆分为多个步骤，并为每个步骤定制提示词，然后交由 Claude Code 的 AI 编程智能体执行。
...
这些任务通常需要多步骤协作，且执行时间长、容易中断。Search Light Agent Team 提供了：
...
Search Light Agent Team 基于 Claude Code 的无头模式实现：
